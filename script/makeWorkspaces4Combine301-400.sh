...
for ((mass=712;mass<850;mass++))#mass in   150 160 170 180 190 210 220 230 240 260 270 280 290 300 310 320 330 340 360 370 380 390 400 410 420 430 440 450 460 470 480 490 500 510 520 530 540 550 560 570 580 590 600 610 620 630 640 650 660 670 680 690 700 710 720 730 740 760 770 780 790 810 820 830 840 850
  do
  for width in 7 #0.1 2 5 10
    do
    for model in  BwSyst
      do
